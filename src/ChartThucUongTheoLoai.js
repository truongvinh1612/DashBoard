...
class ThucUong extends Component {
    ...
    render() {
        const DARK_COLORS = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b', '#e377c2', '#7f7f7f', '#bcbd22', '#17becf'];
        return (
            <div style={{ width: '80%', height: 400, position: 'relative' }}>
                <div style={{ position: 'absolute', top: 0, textAlign: 'center', width: '100%', marginTop: '10px' }}>
